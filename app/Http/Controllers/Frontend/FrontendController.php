...
class FrontendController extends Controller
{
    ...
    public function shop(Request $request)
    {
        ...
        $min_price = Product::where('status', 1)->min('new_price');
        $max_price = Product::where('status', 1)->max('new_price');
        ...
        return view('frontEnd.layouts.pages.shop', compact('products', 'categories', 'min_price', 'max_price'));
    }
