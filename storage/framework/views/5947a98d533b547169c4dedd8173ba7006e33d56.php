...
<div class="container-fluid">
        ...
        <div class="col-12">
            <div class="page-title-box">
                <div class="page-title-right">
                    <a href="<?php echo e(route('pages.index')); ?>" class="btn btn-primary rounded-pill">Manage</a>
                </div>
   ...
   <div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                <form action="<?php echo e(route('pages.update')); ?>" method="POST" class=row data-parsley-validate=""  enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" name="description" rows="6"  id="description" required=""><?php echo $edit_data->description; ?></textarea>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backEnd.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/creativedesignbd/ecommerce3.creativedesign.com.bd/resources/views/backEnd/createpage/edit.blade.php ENDPATH**/ ?>