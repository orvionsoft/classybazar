...
<?php $__env->startSection('title','Order Status Manage'); ?>
        ...
        <div class="col-12">
            <div class="page-title-box">
                <div class="page-title-right">
                    <a href="<?php echo e(route('orderstatus.create')); ?>" class="btn btn-primary rounded-pill">Create</a>
                </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="button-list">
                                    ...
                                    <form method="post" action="<?php echo e(route('orderstatus.inactive')); ?>" class="d-inline"> 
                                    <?php echo csrf_field(); ?>
                                    ...
                                    <?php else: ?>
                                    <form method="post" action="<?php echo e(route('orderstatus.active')); ?>" class="d-inline">
                                        <?php echo csrf_field(); ?>
                                    <input type="hidden" value="<?php echo e($value->id); ?>" name="hidden_id">        
                                    ...
                                    <a href="<?php echo e(route('orderstatus.edit',$value->id)); ?>" class="btn btn-xs btn-primary waves-effect waves-light"><i class="fe-edit-1"></i></a>

                                    <form method="post" action="<?php echo e(route('orderstatus.destroy')); ?>" class="d-inline">        
                                        <?php echo csrf_field(); ?>
                                    <input type="hidden" value="<?php echo e($value->id); ?>" name="hidden_id">
...
<!-- third party js ends -->
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backEnd.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/creativedesignbd/ecommerce3.creativedesign.com.bd/resources/views/backEnd/orderstatus/index.blade.php ENDPATH**/ ?>