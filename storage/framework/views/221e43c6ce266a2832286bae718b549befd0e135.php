...
<style>
    input[type="radio"].form-check-input:checked {
        background-color: rgb(238, 128, 33) !important;
        border-color: rgb(238, 128, 33) !important;
    }
    input[type="radio"].form-check-input:focus {
        border-color: rgb(238, 128, 33) !important;
        box-shadow: 0 0 0 0.2rem rgba(238, 128, 33, 0.25) !important;
    }
    ...
    textarea.form-control.is-valid {
        ...
        box-shadow: 0 0 0 0.2rem rgba(3, 164, 22, 0.25) !important;
    }
...
unset($__errorArgs, $__bag); ?>" name="name"
                                                ...
                                                required data-parsley-required-message="This value is required." />
                ...
                <div class="cart_details table-responsive-sm">
                    <div class="card">
                        ...
                        <div class="card-footer" style="color: black;">
                            <style>.card-footer a { color: #03a416 !important; }</style>
...
<?php echo $__env->make('frontEnd.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\orvionshop3\resources\views/frontEnd/layouts/customer/checkout.blade.php ENDPATH**/ ?>