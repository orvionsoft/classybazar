...
<?php $__env->startSection('title','Contact Manage'); ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="button-list">
                                    ...
                                    <form method="post" action="<?php echo e(route('contact.inactive')); ?>" class="d-inline"> 
                                    <?php echo csrf_field(); ?>
                                    ...
                                    <?php else: ?>
                                    <form method="post" action="<?php echo e(route('contact.active')); ?>" class="d-inline">
                                        <?php echo csrf_field(); ?>
                                    <input type="hidden" value="<?php echo e($value->id); ?>" name="hidden_id">        
                                    ...
                                    <a href="<?php echo e(route('contact.edit',$value->id)); ?>" class="btn btn-xs btn-primary waves-effect waves-light"><i class="fe-edit-1"></i></a>
...
<!-- third party js ends -->
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backEnd.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/creativedesignbd/ecommerce3.creativedesign.com.bd/resources/views/backEnd/contact/index.blade.php ENDPATH**/ ?>