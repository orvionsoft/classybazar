...
<?php $__env->startSection('title','Shipping Charge Manage'); ?> 
        ...
        <div class="col-12">
            <div class="page-title-box">
                <div class="page-title-right">
                    <a href="<?php echo e(route('shippingcharges.create')); ?>" class="btn btn-primary waves-effect waves-light btn-sm rounded-pill">Create</a>
                </div>
                            ...
                            <tr style="vertical-align: middle;">
                                ...
                                <td>
                                    <div class="button-list">
                                        ...
                                        <form method="post" action="<?php echo e(route('shippingcharges.inactive')); ?>" class="d-inline">
                                            <?php echo csrf_field(); ?>
                                        ...
                                        <?php else: ?>
                                        <form method="post" action="<?php echo e(route('shippingcharges.active')); ?>" class="d-inline">
                                            <?php echo csrf_field(); ?>
                                            <input type="hidden" value="<?php echo e($value->id); ?>" name="hidden_id" />
                                        ...
                                        <a href="<?php echo e(route('shippingcharges.edit',$value->id)); ?>" class="btn btn-xs btn-primary waves-effect waves-light"><i class="fe-edit-1"></i></a>

                                        <form method="post" action="<?php echo e(route('shippingcharges.destroy')); ?>" class="d-inline">
                                            <?php echo csrf_field(); ?>
                                            <input type="hidden" value="<?php echo e($value->id); ?>" name="hidden_id" />
...
<?php echo $__env->make('backEnd.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/creativedesignbd/ecommerce3.creativedesign.com.bd/resources/views/backEnd/shippingcharge/index.blade.php ENDPATH**/ ?>