                                            ...
                                            <form action="<?php echo e(route('cart.store')); ?>" method="POST" name="formName">
                                                ...
                                                <?php if($productcolors->count() > 0): ?>
                                                    ...
                                                    <?php endif; ?> <?php if($productsizes->count() > 0): ?>
                                                        <div class="pro-size" style="width: 100%; display: none;">
                                                            <div class="size_inner">
                                                                <p>Weight - <span class="attibute-name"></span></p>
                                                                <div class="size-container">
                                                                    <div class="selector">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="d-flex single_product col-sm-12">
                                                                ...
                                                                <input type="submit" id="order_now" 
...
<?php echo $__env->make('frontEnd.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/classyba/public_html/resources/views/frontEnd/layouts/pages/details.blade.php ENDPATH**/ ?>