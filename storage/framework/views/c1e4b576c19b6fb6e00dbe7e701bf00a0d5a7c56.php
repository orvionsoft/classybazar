...
<div class="container-fluid">
   ...
   <div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                <form action="<?php echo e(route('users.update')); ?>" method="POST" class=row data-parsley-validate=""  enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" name="password" value="" id="password" >
...
unset($__errorArgs, $__bag); ?>" name="confirm-password" value=""  id="confirm-password" >
                            ...
                            <label for="roles" class="form-label">Role *</label>
                             <select class="form-control select2-multiple" name="roles[]" data-toggle="select2"  multiple="multiple" data-placeholder="Choose ..." required>
                                <optgroup label="Select Role">
                                    ...
                                    <option value="<?php echo e($role->name); ?>" <?php $__currentLoopData = $edit_data->roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $srole): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <?php echo e($srole->id==$role->id?'selected':''); ?> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>><?php echo e($role->name); ?></option>
...
unset($__errorArgs, $__bag); ?>" name="image" value="<?php echo e($edit_data->image); ?>"  id="image" >
                            <img src="<?php echo e(asset($edit_data->image)); ?>" alt="">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backEnd.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/creativedesignbd/ecommerce3.creativedesign.com.bd/resources/views/backEnd/users/edit.blade.php ENDPATH**/ ?>