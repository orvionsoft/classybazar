...
<?php $__env->startSection('title','Size Create'); ?>
...
<div class="container-fluid">
   ...
   <div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                <form action="<?php echo e(route('sizes.store')); ?>" method="POST" class=row data-parsley-validate=""  enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <div class="col-sm-6">
...
unset($__errorArgs, $__bag); ?>" name="sizeName" value="<?php echo e(old('sizeName')); ?>"  id="sizeName" required="">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backEnd.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/classyba/public_html/resources/views/backEnd/size/create.blade.php ENDPATH**/ ?>