...
<?php $__env->startSection('title','Size Edit'); ?>
...
<div class="container-fluid">
        ...
        <div class="col-12">
            <div class="page-title-box">
                <div class="page-title-right">
                    <a href="<?php echo e(route('sizes.index')); ?>" class="btn btn-primary rounded-pill">Manage</a>
                </div>
   ...
   <div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                <form action="<?php echo e(route('sizes.update')); ?>" method="POST" class=row data-parsley-validate=""  enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <input type="hidden" value="<?php echo e($edit_data->id); ?>" name="id">
                    <div class="col-sm-6">
                        <div class="form-group mb-3">
                            <label for="sizeName" class="form-label">Size Name *</label>
                            <input type="text" class="form-control <?php $__errorArgs = ['sizeName'];
...
unset($__errorArgs, $__bag); ?>" name="sizeName" value="<?php echo e($edit_data->sizeName); ?>"  id="sizeName" required="">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backEnd.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/creativedesignbd/ecommerce3.creativedesign.com.bd/resources/views/backEnd/size/edit.blade.php ENDPATH**/ ?>