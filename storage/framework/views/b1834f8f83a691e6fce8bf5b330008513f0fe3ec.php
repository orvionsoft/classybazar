...
unset($__errorArgs, $__bag); ?>
                        ...
                        <!-- col-end -->
                        <a href="<?php echo e(route('customer.forgot.password')); ?>" class="forget-link"><i class="fa-solid fa-unlock"></i> পাসওয়ার্ড ভুলে গেছেন?</a>
                        <div class="form-group mb-3">
                     ...
                     <div class="register-now no-account">
                        ...
                        <a href="<?php echo e(route('customer.register')); ?>"><i data-feather="edit-3"></i> রেজিস্ট্রেশন করুন</a>
                    </div>
                </div>
            </div>
        </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('frontEnd.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/creativedesignbd/ecommerce3.creativedesign.com.bd/resources/views/frontEnd/layouts/customer/login.blade.php ENDPATH**/ ?>