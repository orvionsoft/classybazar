...
<section class="customer-invoice">
    <div class="container">
        <div class="row">
            <div class="col-sm-6">
                <a href="<?php echo e(route('customer.orders')); ?>" class="no-print"><strong><i class="fa-solid fa-arrow-left"></i> Back To Order</strong></a>
            </div>
                ...
                <div class="invoice-innter print-area" style="width: 900px;margin: 0 auto;background: #f9f9f9;overflow: hidden;padding: 30px;padding-top: 0;">
                        ...
                        <tr>
                            ...
                            <td  style="width:60%;float: left;">
                                ...
                                <div class="invoice-bar" style="background:#fff; transform: skew(36deg); width: 80%; margin-left: 182px; padding: 12px 32px; margin-top: 6px;text-align:right">
                                   ...
                                   <p style="transform: skew(-36deg);display:inline-block; margin-left: 10px;">Invoice No: <strong><?php echo e($order->invoice_id); ?></strong></p>
                                </div>
                    ...
                    <table class="table" style="margin-top: 30px; width: 100%; border-collapse: collapse;">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td style="padding: 8px; border-bottom: 1px solid #ddd;"><?php echo e($loop->iteration); ?></td>
                                <td style="padding: 8px; border-bottom: 1px solid #ddd;"><?php echo e($value->product_name); ?></td>
                                <td style="padding: 8px; border-bottom: 1px solid #ddd;">৳<?php echo e($value->sale_price); ?></td>
                                <td style="padding: 8px; border-bottom: 1px solid #ddd;"><?php echo e($value->qty); ?></td>
                                <td style="padding: 8px; border-bottom: 1px solid #ddd;">৳<?php echo e($value->sale_price*$value->qty); ?></td>
                            </tr>
                        ...
                        <table class="table" style="width: 300px; float: right; margin-bottom: 30px; border-collapse: collapse;">
                            <tbody style="background:#00aef0">
                                <tr style="color:#fff">
                                    ...
                                    <td style="padding: 8px;"><strong>৳<?php echo e($order->orderdetails->sum('sale_price')); ?></strong></td>
                                </tr>
                                <tr style="color:#fff">
                                    <td style="padding: 8px;"><strong>Shipping(+)</strong></td>
                                    <td style="padding: 8px;"><strong>৳<?php echo e($order->shipping_charge); ?></strong></td>
                                </tr>
                                <tr style="color:#fff">
                                    <td style="padding: 8px;"><strong>Discount(-)</strong></td>
                                    <td style="padding: 8px;"><strong>৳<?php echo e($order->discount); ?></strong></td>
                                </tr>
                                <tr style="background:#00aef0;color:#fff">
                                    <td style="padding: 8px;"><strong>Final Total</strong></td>
                                    <td style="padding: 8px;"><strong>৳<?php echo e($order->amount); ?></strong></td>
                                </tr>
                            </tbody>
                        </table>
                        
                        <div class="terms-condition" style="overflow: hidden; width: 100%; text-align: center; padding: 20px 0; border-top: 1px solid #ddd;">
                            <h5 style="font-style: italic;"><a href="<?php echo e(route('page',['slug'=>'terms-condition'])); ?>" style="text-decoration: none; color: #333;">Terms & Conditions</a></h5>
...
<?php echo $__env->make('frontEnd.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\orvionshop3\resources\views/frontEnd/layouts/customer/invoice.blade.php ENDPATH**/ ?>