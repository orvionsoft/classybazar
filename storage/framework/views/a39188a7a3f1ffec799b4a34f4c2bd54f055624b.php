    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <!--                <input type="text" value="<?php echo e(request()->get('keyword')); ?>" name="keyword" placeholder="Search">-->
                ...
                <div class="table-responsive ">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php if($value->status=='active'): ?><span class="badge bg-soft-success text-success">Active</span> <?php else: ?> <span class="badge bg-soft-danger text-danger"><?php echo e($value->status); ?></span> <?php endif; ?></td>
                            <td>
                                <div class="button-list">
                                    ...
                                    <a href="<?php echo e(route('customers.edit',$value->id)); ?>" class="btn btn-xs btn-primary waves-effect waves-light"><i class="fe-edit-1"></i></a>

                                    <a href="<?php echo e(route('customers.profile',['id'=>$value->id])); ?>" class="btn btn-xs btn-blue waves-effect waves-light"><i class="fe-eye"></i></a>
...
<!-- third party js ends -->
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backEnd.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/creativedesignbd/ecommerce3.creativedesign.com.bd/resources/views/backEnd/customer/index.blade.php ENDPATH**/ ?>