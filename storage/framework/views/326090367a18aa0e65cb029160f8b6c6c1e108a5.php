...
<?php $__env->startSection('title','Size Manage'); ?>
        ...
        <div class="col-12">
            <div class="page-title-box">
                <div class="page-title-right">
                    <a href="<?php echo e(route('sizes.create')); ?>" class="btn btn-primary rounded-pill">Create</a>
                </div>
                <h4 class="page-title">Weight Manage</h4>
            </div>
        </div>
    </div>       
    <!-- end Size title --> 
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="button-list">
                                    ...
                                    <form method="post" action="<?php echo e(route('sizes.inactive')); ?>" class="d-inline"> 
                                    <?php echo csrf_field(); ?>
                                    ...
                                    <?php else: ?>
                                    <form method="post" action="<?php echo e(route('sizes.active')); ?>" class="d-inline">
                                        <?php echo csrf_field(); ?>
                                    <input type="hidden" value="<?php echo e($value->id); ?>" name="hidden_id">        
                                    ...
                                    <a href="<?php echo e(route('sizes.edit',$value->id)); ?>" class="btn btn-xs btn-primary waves-effect waves-light"><i class="fe-edit-1"></i></a>

                                    <form method="post" action="<?php echo e(route('sizes.destroy')); ?>" class="d-inline">        
                                        <?php echo csrf_field(); ?>
                                    <input type="hidden" value="<?php echo e($value->id); ?>" name="hidden_id">
...
<!-- third party js ends -->
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backEnd.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\orvionshop3\resources\views/backEnd/size/index.blade.php ENDPATH**/ ?>