                        ...
                        <tr>
                            ...
                            <td>
                                <div class="button-list">
                                    ...
                                    <a href="<?php echo e(url('campaign',$value->slug)); ?>" class="btn btn-xs btn-primary waves-effect waves-light" target="_blank"><i class="fe-eye"></i></a>

                                    <?php if($value->status == 1): ?>
                                    <form method="post" action="<?php echo e(route('campaign.inactive')); ?>" class="d-inline"> 
                                    <?php echo csrf_field(); ?>
                                    ...
                                    <?php else: ?>
                                    <form method="post" action="<?php echo e(route('campaign.active')); ?>" class="d-inline">
                                        <?php echo csrf_field(); ?>
                                    <input type="hidden" value="<?php echo e($value->id); ?>" name="hidden_id">        
                                    ...
                                    <a href="<?php echo e(route('campaign.edit',$value->id)); ?>" class="btn btn-xs btn-primary waves-effect waves-light"><i class="fe-edit-1"></i></a>
...
<!-- third party js ends -->
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backEnd.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/creativedesignbd/ecommerce3.creativedesign.com.bd/resources/views/backEnd/campaign/index.blade.php ENDPATH**/ ?>