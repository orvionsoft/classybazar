...
<div class="container-fluid">
  ...
  text-align: left;   
    ...
    <div class="banner-left">
      <img src="<?php echo e(asset($generalsetting->dark_logo)); ?>" alt="Logo">
      <div class="text">
       অরভিয়নসফট ই-কমার্স ম্যানেজমেন্ট সিস্টেম <br>
        <small>🛑 বিঃদ্রঃ নামাজের সময় সাপোর্ট বন্ধ থাকব থাকবে</small>
      </div>
    </div>
    ...
    <div class="banner-right">
      <div class="phone">
        📞 যোগাযোগঃ 01940862387
      </div>
      <small>যোগাযোগের সময় সকাল ৯:০০টা থেকে সন্ধ্যা ৭:০০টা পর্যন্ত</small>
    </div>
  </div>
    <!-- end page title --> 
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backEnd.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/orvionso/orvionshop3.orvionsoft.com/resources/views/backEnd/admin/dashboard.blade.php ENDPATH**/ ?>