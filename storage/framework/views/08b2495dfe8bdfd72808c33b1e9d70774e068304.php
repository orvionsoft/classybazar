...
<section class="customer-invoice ">
    <div class="container">
        <div class="row">
            <div class="col-sm-6">
                <a href="https://classybazar.com/admin/order/all" class="no-print"><strong><i class="fe-arrow-left"></i> Back To Order</strong></a>
            </div>
            <div class="col-sm-6">
                        ...
                        <table class="table" style="width: 300px; float: right;    margin-bottom: 30px;">
                            <tbody style="background:#f1f9f8">
                                <tr>
                                    ...
                                    <td><strong>৳<?php echo e($order->orderdetails->sum(function($item) { return $item->sale_price * $item->qty; })); ?></strong></td>
                                </tr>
                                <tr>
...
<?php echo $__env->make('backEnd.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Classybazar\resources\views/backEnd/order/invoice.blade.php ENDPATH**/ ?>