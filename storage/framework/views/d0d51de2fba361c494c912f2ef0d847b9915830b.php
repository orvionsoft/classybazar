...
<?php $__env->startSection('title','Permissions Manage'); ?>
        ...
        <div class="col-12">
            <div class="page-title-box">
                <div class="page-title-right">
                    <a href="<?php echo e(route('permissions.create')); ?>" class="btn btn-primary rounded-pill">Create</a>
                </div>
                <h4 class="page-title">Permissions Manage</h4>
            </div>
        </div>
    </div>       
    <!-- end page title --> 
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="button-list">
                                    ...
                                    <a href="<?php echo e(route('permissions.edit',$value->id)); ?>" class="btn btn-xs btn-primary waves-effect waves-light"><i class="fe-edit-1"></i></a>

                                    <form method="post" action="<?php echo e(route('permissions.destroy')); ?>" class="d-inline">        
                                        <?php echo csrf_field(); ?>
...
<!-- third party js ends -->
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backEnd.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/creativedesignbd/ecommerce3.creativedesign.com.bd/resources/views/backEnd/permissions/index.blade.php ENDPATH**/ ?>