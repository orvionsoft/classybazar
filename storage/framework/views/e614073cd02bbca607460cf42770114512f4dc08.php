...
<div class="container-fluid">
   ...
   <div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                <form action="<?php echo e(route('users.store')); ?>" method="POST" class=row data-parsley-validate=""  enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <div class="col-sm-6">
...
unset($__errorArgs, $__bag); ?>" name="email" value="<?php echo e(old('email')); ?>"  id="email" required="">
...
unset($__errorArgs, $__bag); ?>" name="password" value="<?php echo e(old('password')); ?>" id="password" required="">
...
unset($__errorArgs, $__bag); ?>" name="confirm-password" value="<?php echo e(old('confirm-password')); ?>"  id="confirm-password" required="">
...
unset($__errorArgs, $__bag); ?>" name="image" value="<?php echo e(old('image')); ?>"  id="image" required="">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backEnd.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/creativedesignbd/ecommerce3.creativedesign.com.bd/resources/views/backEnd/users/create.blade.php ENDPATH**/ ?>