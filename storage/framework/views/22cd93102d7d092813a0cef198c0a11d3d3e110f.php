...
unset($__errorArgs, $__bag); ?>
                     ...
                     <div class="register-now no-account">
                        ...
                        <a href="<?php echo e(route('customer.register')); ?>"> রেজিস্ট্রেশন করুন</a>
                    </div>
                </div>
            </div>
        </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('frontEnd.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/classyba/public_html/resources/views/frontEnd/layouts/customer/login.blade.php ENDPATH**/ ?>