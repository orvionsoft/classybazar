    ...
    <div id="wrapper">
        ...
        <div class="container-fluid">
          <ul class="list-unstyled topnav-menu float-end mb-0">
            ...
            <li class="dropdown notification-list topbar-dropdown">
              <a class="nav-link dropdown-toggle nav-user me-0 waves-effect waves-light" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                ...
                <span class="pro-user-name ms-1"> <?php echo e(Auth::user()->name); ?> <i class="mdi mdi-chevron-down"></i> </span>
              </a>
          ...
          <div class="logo-box">
            <a href="<?php echo e(url('admin/dashboard')); ?>" class="logo logo-dark text-center">
              <span class="logo-sm">
                <img src="<?php echo e(asset($generalsetting->dark_logo)); ?>" alt="" height="50" />
      ...
      <div class="left-side-menu">
        <div class="h-100" data-simplebar>
          ...
          <div class="user-box text-center">
            ...
            <div class="dropdown">
              <a href="javascript: void(0);" class="text-dark dropdown-toggle h5 mt-2 mb-1 d-block" data-bs-toggle="dropdown"><?php echo e(Auth::user()->name); ?></a>
          ...
          <div id="sidebar-menu">
            <ul id="side-menu">
              <li>
                <a href="<?php echo e(url('admin/dashboard')); ?>" data-bs-toggle="collapse">
              ...
              <li>
                ...
                <div class="collapse" id="sidebar-orders">
                  <ul class="nav-second-level">
                    <li>
                      <a href="<?php echo e(route('admin.orders',['slug'=>'all'])); ?>"><i data-feather="file-plus"></i> All Order</a>
                    </li>
                    ...
                    <li>
                      <a href="<?php echo e(route('admin.orders',['slug'=>$value->slug])); ?>"><i data-feather="file-plus"></i><?php echo e($value->name); ?></a>
                    </li>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                  </ul>
                </div>
              ...
              <li>
                ...
                <div class="collapse" id="siebar-product">
                  <ul class="nav-second-level">
                    <li>
                      <a href="<?php echo e(route('products.index')); ?>"><i data-feather="file-plus"></i> Product Manage</a>
                    </li>
                    <li>
              ...
              <li>
                ...
                <div class="collapse" id="sidebar-product-review">
                  <ul class="nav-second-level">                   
                    <li>
                      <a href="<?php echo e(route('reviews.pending')); ?>"><i data-feather="file-plus"></i> Pending Reviews (<?php echo e($pending_reviews); ?>)</a>
                    </li>
                    <li>
              ...
              <li>
                ...
                <div class="collapse" id="sidebar-users">
                  <ul class="nav-second-level">
                    <li>
                      <a href="<?php echo e(route('users.index')); ?>"><i data-feather="file-plus"></i> User</a>
                    </li>
                    <li>
                      <a href="<?php echo e(route('roles.index')); ?>"><i data-feather="file-plus"></i> Roles</a>
                    </li>
                    <li>
                      <a href="<?php echo e(route('permissions.index')); ?>"><i data-feather="file-plus"></i> Permissions</a>
                    </li>
                    <li>
      ...
      <div class="content-page">
        ...
        <footer class="footer">
          <div class="container-fluid">
            <div class="row">
              <div class="col-md-12 text-end"><a href="https://www.orvionshop3.orvionsoft.com/" target="_blank">Website Designed by: OrrvionSoft Design</a></div>
            </div>
          </div>
        </footer>
        <!-- end Footer -->
...
<?php /**PATH /home/orvionso/orvionshop3.orvionsoft.com/resources/views/backEnd/layouts/master.blade.php ENDPATH**/ ?>