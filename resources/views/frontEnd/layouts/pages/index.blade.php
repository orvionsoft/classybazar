                    ...
                    @foreach ($menucategories as $key => $value)
                        <div>
                            <div class="text-center ">
                                <a href="{{ route('category', $value->slug) }}">
                                    <img class="" id="top-category-img" src="{{ asset($value->image) }}" alt="" style="height: 170px; border: 2px solid #3c7d17; border-radius: 50%; width: 100%;" />
                                </a>
                            </div>
        ...
        <div class="row">
            ...
            <div class="col-sm-12 mt-3">
                <div class="d-flex justify-content-center">
                    <a href="{{ route('shop') }}" class="btn btn-success px-4 py-2" style="background: #03a416; border-color: #03a416;">View More</a>
                </div>
            </div>
            @endif
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <a href="{{$bottomAds->link}}?sold=show">
                <img style=" width: 100%;" src="{{$bottomAds->image}}"/>
            </a>
        </div>
        @endforeach
    </div>
