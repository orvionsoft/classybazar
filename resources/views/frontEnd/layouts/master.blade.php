...
<html lang="en">
    <head>
        ...
        <link rel="shortcut icon" href="{{asset($generalsetting->favicon)}}" alt="{{$generalsetting->name}} Favicon" />
                <meta name="author" content="Classy Bazar">
                <meta name="robots" content="index, follow">

                <title>সেরা মশলা ও খাবারের প্রিমিয়াম কালেকশন | Classy Bazar</title>

                <!-- SEO Meta Tags -->
                <meta name="description" content="Classy Bazar থেকে কিনুন সেরা মানের মশলা, মধু, বাদাম ও প্রিমিয়াম খাবার। সারা বাংলাদেশে দ্রুত ডেলিভারি ও ১০০% প্রাকৃতিক পণ্য। এখনই অর্ডার করুন!">
                <meta name="keywords" content="organic food Bangladesh, premium spices BD, natural food online BD, honeynute,healthy food BD,classy bazar,ghorerbazar,100%organicfood">

                <!-- Canonical URL -->
                <link rel="canonical" href="https://classybazar.com/">

                <!-- Open Graph (Facebook SEO) -->
                <meta property="og:type" content="website">
                <meta property="og:title" content="সেরা মশলা ও প্রিমিয়াম খাবার | Classy Bazar">
                <meta property="og:description" content="প্রিমিয়াম মশলা, মধু, বাদাম ও অর্গানিক খাবার এখন এক জায়গায়। দ্রুত ডেলিভারি সারা বাংলাদেশে।">
                <meta property="og:url" content="https://classybazar.com/">
                <meta property="og:image" content="https://classybazar.com/images/og-image.jpg">

                <!-- Twitter Card -->
                <meta name="twitter:card" content="summary_large_image">
                <meta name="twitter:title" content="সেরা মশলা ও প্রিমিয়াম খাবার | Classy Bazar">
                <meta name="twitter:description" content="Buy premium spices, honey & organic food in Bangladesh. Fast delivery available.">
                ...
                <script type="application/ld+json">
                {
                    ...
                    "@type": "Store",
                    "name": "Classy Bazar",
                    "url": "https://classybazar.com/",
                    "logo": "https://classybazar.com/images/og-image.jpg",
                    "description": "Classy Bazar থেকে কিনুন সেরা মানের মশলা, মধু, বাদাম ও প্রিমিয়াম খাবার। সারা বাংলাদেশে দ্রুত ডেলিভারি ও ১০০% প্রাকৃতিক পণ্য।",
                    "address": {
                        "@type": "PostalAddress",
                        "addressCountry": "BD"
                    },
                    "sameAs": [
                        "https://www.facebook.com/classybazarbd",
                        "https://www.instagram.com/classybazarbd"
                    ]
                }
                </script>
        ...
        <header id="navbar_top">
            ...
            <div class="top_header" style="background-color:#3c7d17">
                    <div class="container d-flex align-items-center">
                        ...
                        <a href="tel:{{ $contact->hotline }}" class="text-center bg-light px-2 d-none d-sm-block fw-bold fs-4" style="color:rgb(238,128,33);min-width:270px;">
        ...
        <div class="footer-section">
            ...
            <ul style="list-style: none !important; padding: 0 !important; margin: 0 !important;">
                <li style="margin-bottom: 12px !important; list-style: none !important; display: block !important;">
                    <a href="{{ route('home') }}" style="color: #e0e0e0 !important; text-decoration: none !important; transition: all 0.3s ease; display: inline-block !important; position: relative;">Home</a>
                </li>
                <li style="margin-bottom: 12px !important; list-style: none !important; display: block !important;">
                    <a href="{{ route('shop') }}" style="color: #e0e0e0 !important; text-decoration: none !important; transition: all 0.3s ease; display: inline-block !important; position: relative;">Products</a>
                </li>
                <li style="margin-bottom: 12px !important; list-style: none !important; display: block !important;">
                    <a href="{{ route('contact') }}" style="color: #e0e0e0 !important; text-decoration: none !important; transition: all 0.3s ease; display: inline-block !important; position: relative;">Contact</a>
                </li>
                @foreach($pages as $page)
                    <li style="margin-bottom: 12px !important; list-style: none !important; display: block !important;">
                        <a href="{{ route('page',['slug'=>$page->slug]) }}" style="color: #e0e0e0 !important; text-decoration: none !important; transition: all 0.3s ease; display: inline-block !important; position: relative;">
                            {{$page->name}}
                        </a>
                    </li>
                @endforeach
        ...
        <div class="footer-section">
            ...
            <ul style="list-style: none !important; padding: 0 !important; margin: 0 !important;">
                @foreach($pagesright as $value)
                    <li style="margin-bottom: 12px !important; list-style: none !important; display: block !important;">
                        <a href="{{ route('page',['slug'=>$value->slug]) }}" style="color: #e0e0e0 !important; text-decoration: none !important; transition: all 0.3s ease; display: inline-block !important; position: relative;">
                            {{$value->name}}
                        </a>
                    </li>
                @endforeach
        ...
        <div class="footer-section">
            ...
            <div style="font-size: 0.95rem;" class="contact-info">
                ...
                <p style="margin: 0 0 15px 0; display: flex; align-items: center; color: #e0e0e0; gap: 12px;">
                    ...
                    <span>{{$contact->email ?? 'support@email.com'}}</span>
                </p>
    ...
    <div style="border-top: 1px solid gray; margin-top: 20px;">
        <div style="display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 20px;" class="footer-bottom">
            ...
            <p style="font-size: 0.9rem; color: #e0e0e0; margin: 0;">
                © {{ date('Y') }} {{$generalsetting->name}}. All rights reserved. Website Designed & Developed by: <a href="https://orvionsoft.com" target="_blank" style="color: white; font-weight: 600;">OrvionSoft</a>
            </p>
