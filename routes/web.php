...
// bKash may POST or redirect using GET depending on outcome; accept any method
Route::any('bkash/checkout-url/callback',[BkashController::class,'callback'])->name('url-callback');
